...
public class DeleteUtility {
    ...
    public static <T extends BaseEntity> T softDeleteById(Long id,
    ...
    public static <T> T softDeleteByField(String field,
                                          Optional<T> entityOptional,
    ...
    public static void softCascadeDelete(SpecialtyEntity specialtyEntity,
